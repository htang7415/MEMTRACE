from memtrace.evaluation.tables import build_supplementary_tables, build_table1
...
def test_build_table1_renders_system_rows() -> None:
        ...
        "by_configuration": {
            "mlx-community/Qwen2.5-3B-Instruct-4bit": {
                "S0": {
                    ...
                    "PAR": 0.0,
                    "PAR_ci95": [0.0, 0.1],
                    "PAR_executed_only": 0.0,
                    "PAR_executed_only_ci95": [0.0, 0.1],
                    "WR": 0.0,
                    "WR_ci95": [0.0, 0.1],
                    "HDR": 0.0,
                    "CWRR": 1.0,
                    "phi": None,
                    "phi_ci95": None,
                    "phi_status": "undefined_par_zero",
                    "planner_structured_output_rate": 1.0,
                    "planner_explicit_null_rate": 0.0,
                    "planner_malformed_output_rate": 0.0,
                    "execution_failure_rate": 0.0,
                    "required_tool_call_rate": 1.0,
                    "writer_structured_turn_rate": 1.0,
                    "writer_malformed_turn_rate": 0.0,
                ...
                "S1": {
                    ...
                    "PAR": 1.0,
                    "PAR_ci95": [0.9, 1.0],
                    "PAR_executed_only": 0.75,
                    "PAR_executed_only_ci95": [0.4, 0.95],
                    "WR": 1.0,
                    "WR_ci95": [0.9, 1.0],
                    "HDR": 0.1,
                    "CWRR": 0.0,
    ...
    assert (
        "| Qwen2.5-3B | S0 | 1.000 | 0.500 | [0.200, 0.800] | 0.500 | [0.200, 0.800] | 0.000 | [0.000, 0.100] | 0.000 | [0.000, 0.100] | N/A |"
        in table
    )
    assert (
        "| Qwen2.5-3B | S1 | 1.000 | 0.500 | [0.200, 0.800] | 0.800 | [0.500, 0.950] | 1.000 | [0.900, 1.000] | 0.750 | [0.400, 0.950] | False |"
        in table
    )
...
def test_build_supplementary_tables_groups_by_task() -> None:
    episode_scores = [
        {
            "episode_id": "qwen25_3b:S1:task-a:stateful:d1:direct_override",
        ...
        {
            "episode_id": "qwen25_3b:S1:task-a:stateful:d3:direct_override",
            "actor_model": "mlx-community/Qwen2.5-3B-Instruct-4bit",
            "task_id": "task-a",
            "system": "S1",
            "episode_kind": "stateful_attack",
...
def test_build_supplementary_tables_renders_na_for_zero_executed_par_exec_and_horizon_ef() -> None:
    episode_scores = [
        {
            "episode_id": "llama:S1:task-a:stateful:d1:direct_override",
