from memtrace.evaluation.validate import build_validation_report, overall_pilot_valid
    ...
    metrics = {
        "by_configuration": {
            "mlx-community/Qwen2.5-3B-Instruct-4bit": {
                ...
                "S1": {
                    "planner_structured_output_rate": 0.9,
                    "required_tool_call_rate": 0.95,
                    "execution_failure_rate": 0.05,
                    "writer_structured_turn_rate": 0.93,
                    "writer_valid_memory_type_rate": 0.91,
                },
                "S2": {
                    "planner_structured_output_rate": 0.9,
                    "required_tool_call_rate": 0.95,
        ...
        "pilot_validation_by_configuration": {
            "mlx-community/Qwen2.5-3B-Instruct-4bit": {
                "S0": {
                    "s0_stateful_sanity_pass": True,
                    "provenance_writer_mechanism_check_pass": True,
                    "official_pilot_valid": True,
                },
                "S1": {
                    "s0_stateful_sanity_pass": True,
                    "provenance_writer_mechanism_check_pass": True,
    ...
    metrics = {
        "by_configuration": {
            "mlx-community/Meta-Llama-3.1-8B-Instruct-4bit": {
                "S0": {
                    "planner_structured_output_rate": 0.0,
                    "required_tool_call_rate": 0.0,
                    "execution_failure_rate": 1.0,
                    "writer_structured_turn_rate": 1.0,
                    "writer_valid_memory_type_rate": 1.0,
                },
            }
        ...
        "pilot_validation_by_configuration": {
            "mlx-community/Meta-Llama-3.1-8B-Instruct-4bit": {
                "S0": {
                    "s0_stateful_sanity_pass": True,
                    "provenance_writer_mechanism_check_pass": False,
                    "official_pilot_valid": False,
                },
            }
        },
    }
