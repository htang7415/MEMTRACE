...
from memtrace.core.benchmark import build_task_records, gold_label_for_query, task_id_by_query
...
def _admitted_malicious_candidate(
    ...
    return any(
        record.source_kind == "retrieval" and record.source_id in poison_source_ids for record in accepted_records
    )
