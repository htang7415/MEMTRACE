...
from memtrace.config import ROOT
from memtrace.evaluation.metrics import aggregate_metrics  # noqa: E402
from memtrace.evaluation.scoring import score_run_summary_items  # noqa: E402


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Recompute MEMTRACE metrics from retained traces without model inference."
    )
